...
//	}
//
// Reading events from the server is done in an asynchronous way. The
// functions that read from the server return a read channel that will
// push new events as they come from the server.
//
